...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Chi Tiết Đơn Hàng
            <a style="margin-left: 90rem;" href="{{ route('admin.order.index') }}" class="btn bg-orange btn-flat"><i class="fa fa-list" style="margin-right: 10px"></i> Danh sách đơn hàng</a>
        </h1>
    </section>
    @if (session('msg'))
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <div class="box-header with-border">
                                    <button type="submit" class="btn btn-info btn-flat btn-warning">
